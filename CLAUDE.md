...
| "how do I generate sprites with NovelAI" · "how do I run img2img or inpainting" · "is this generation free" · "how do I ask an agent for a new character" · "is this outfit a data file or mannequin code" · "where do the reference sprites come from" · "how do I send part of an image to NovelAI" · "what is a request file" | [`docs/NAI_SPRITES.md`](docs/NAI_SPRITES.md) |
...
- **You will fix the route that ships and let its SIBLING route grow without
  ...
  because a wrong detector there is a green assertion. **20 sightings** --
  ledger: `docs/history/SIGHTINGS.md`.
