<!-- pyoneer-doc: L1 -->
<!-- GENERATED by tools/check_behavior_docs.py. Do not edit. Regenerate: .venv/Scripts/python.exe tools/check_behavior_docs.py --write -->
...
On the tmx OBJECT, not on the class and not in a table:
    ...
    <property name="pyoneer_param_sprint_verb" value=""/>
...
`pyoneer_actor`; every token's own parameter table is below.
