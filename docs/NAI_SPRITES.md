...
3. **img2img track**, only if a proof row exists.
   - Sweep the seed at the default strength **0.45** (noise 0.05) and keep the
     best seed.
   - Then A/B the strength inside **0.3–0.55**.
