...
> **Filed under `docs/history/` on 2026-08-16 at `d8c303f`. Superseded by [`../PLACEABLE.md`](../PLACEABLE.md), which is generated from the registries this plan proposed, and by [`../../CLAUDE.md`](../../CLAUDE.md) law 11. Kept for the `.tmx` archaeology in PART 0, which nothing else records.**
>
> **ARCHIVE — do not navigate by this file.** the map object-layer plan; its spawn half has landed. Its counts,
