...
> **Filed under `docs/history/` on 2026-08-16 at `d8c303f`. Superseded by [`../BEHAVIORS.md`](../BEHAVIORS.md)'s integration table, which *measures* what is wired by constructing an entity and running frames, on every run. Kept for the archaeology.**
>
> **ARCHIVE — do not navigate by this file.** a survey of finished-but-unattached code, with inline CORRECTED AT / SPENT AT marks. Its counts,
