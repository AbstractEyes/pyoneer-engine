...
> **Filed under `docs/history/` on 2026-08-16 at `d8c303f`. Superseded by [`../../CLAUDE.md`](../../CLAUDE.md) law 3, which is this document's structural conclusion written as a rule with its cost attached. Kept for the measurements behind that rule.**
>
> **ARCHIVE — do not navigate by this file.** the event-system plan; its structural half is now law 3. Its counts,
