...
> **Filed under `docs/history/` on 2026-08-16 at `d8c303f`. Superseded by the commits its own preamble reports as already landed; the surviving rule is [`../../CLAUDE.md`](../../CLAUDE.md) law 2. Kept for the ownership reasoning.**
>
